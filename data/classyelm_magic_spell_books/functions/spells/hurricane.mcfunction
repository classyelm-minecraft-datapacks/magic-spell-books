...
execute as @s[scores={msbv2xmp=10..}] run effect give @e[distance=1..8] minecraft:levitation 1 18 true
execute as @s[scores={msbv2xmp=10..}] run particle minecraft:cloud ~ ~ ~ 0 0.5 0 4 80
execute as @s[scores={msbv2xmp=10..}] run effect give @e[distance=1..8] minecraft:instant_damage 1 0
execute as @s[scores={msbv2xmp=10..}] run effect give @e[distance=1..8] minecraft:regeneration 1 3 true
