...
execute as @e[tag=msbv2xfsf,sort=nearest,limit=1] store result entity @s Motion[0] double 0.025 run scoreboard players get @p[tag=MSBv2xHS,scores={msbv2xhsid=0,msbv2xrcd=1..,msbv2xmp=4..}] msbv2xsx
execute as @e[tag=msbv2xfsf,sort=nearest,limit=1] store result entity @s Motion[1] double 0.025 run scoreboard players get @p[tag=MSBv2xHS,scores={msbv2xhsid=0,msbv2xrcd=1..,msbv2xmp=4..}] msbv2xsy
execute as @e[tag=msbv2xfsf,sort=nearest,limit=1] store result entity @s Motion[2] double 0.025 run scoreboard players get @p[tag=MSBv2xHS,scores={msbv2xhsid=0,msbv2xrcd=1..,msbv2xmp=4..}] msbv2xsz
